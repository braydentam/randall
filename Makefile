...
assignment-files = COPYING Makefile randall.c $(FILES)
...
check: 	
	...
	@echo "=========== TEST 1 ==========="
	@./randall -i /dev/random stdio 20 | wc -c | (grep -q "^20$$" && echo "PASSED") || (echo "FAILED" && false)
	@echo "=========== TEST 2 ==========="
	@./randall 20 | wc -c | (grep -q "^20$$" && echo "PASSED") || (echo "FAILED" && false)
	@echo "=========== TEST 3 ==========="
	@./randall 200 -o 5 | wc -c | (grep -q "^200$$" && echo "PASSED") || (echo "FAILED" && false)
	@echo "=========== TEST 4 ==========="
	@./randall 10 -i lrand48_r | wc -c | (grep -q "^10$$" && echo "PASSED") || (echo "FAILED" && false)
